      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-primary pull-right" style="margin-right: 5px;" data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-calendar-check-o"></i> DEFINIR FECHA ENTREGA
          </button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Fecha de entrega para este pedido:</h4>
              </div>
              <div class="modal-body">
                {!! Form::open(['route'=>'admin.fecha_entrega','method'=>'POST']) !!}
                <div class="form-group">
                  <label>Fecha:</label>
                  <div class="input-group date fs-date">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="text" class="form-control pull-right datepicker" name="datepicker">
                  </div>
                  <input type="hidden" class="idCompra" name="idCompra" value="{{ $informacion->order_id }}">
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                  <button type="submit" class="btn btn-success" >Aprobar pedido y definir fecha</button>
                </div>
              {!! Form::close() !!}
              </div>
            </div>
